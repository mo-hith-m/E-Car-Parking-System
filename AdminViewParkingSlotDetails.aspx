<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminViewParkingSlotDetails.aspx.cs" Inherits="AdminViewParkingDetails" %>
    ...
    <table class="style4">
        <tr>
            <td class="style3" colspan="3" 
                ...
                VIEW PARKING SLOTS DETAILS (RESERVED AND NON RESERVED)</td>
        </tr>
        <tr>
