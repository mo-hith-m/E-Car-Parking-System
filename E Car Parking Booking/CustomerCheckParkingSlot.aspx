<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMasterPage.master" AutoEventWireup="true" CodeFile="CustomerCheckParkingSlot.aspx.cs" Inherits="CustomerCheckParkingSlot" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td bgcolor="Black" colspan="2" class="style6">
            CHECK YOUR RESERVED PARKING SLOT DETAILS</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="border: thin solid #FFCC00; text-align: center;">
            <asp:Image ID="Image2" runat="server" Height="110px" 
                ImageUrl="~/images/img4.gif" Width="244px" />
        </td>
